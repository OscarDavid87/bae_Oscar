...
SELECT * FROM emple ORDER BY dept_no DESC, ORDER BY apellido;

--8 Mostrar los datos de los empleados cuyo salario sea mayor que 2000000.

SELECT * FROM emple ORDER BY salario > 2000000;
...
SELECT * FROM emple ORDER BY oficio, emp_no;
...
SELECT apellido FROM emple WHERE oficio NOT IN ('ANALISTA','EMPLEADO');
